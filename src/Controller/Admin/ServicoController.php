...
class ServicoController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $dados['nome_servico'] = trim(mb_strtoupper($dados['nome_servico'], 'UTF-8'));
            $dados['cod_sistema_servico'] = trim(mb_strtoupper($dados['cod_sistema_servico'], 'UTF-8'));

            $servico = $this->Servico->patchEntity($servico, $dados);
