...
<?= $this->Form->button('Lançar', ['id' => 'submit', 'class' => 'btn btn-outline-dark mb-4 btn-lancar', 'style' => 'visibility: hidden;']) ?>
    ...
    <table class="table table-borderless table-hover table-striped text-center">
        ...
        <tbody class="align-middle">
            <?php foreach ($atividade as $atividade) : ?>
                <tr>
                    <td>
                        <input type="checkbox" name="selecionados[]" value="<?= $atividade->id ?>" class="btn-shadow">
                    </td>
