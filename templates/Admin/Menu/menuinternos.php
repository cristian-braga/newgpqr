    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-6">
            <?php echo $this->Html->link(
                '<i class="fa-solid fa-print fa-5x spin" aria-hidden="true"></i>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <?php echo $this->Html->link(
                '<i class="fa-solid fa-book fa-5x spin" aria-hidden="true"></i>
                <h5>ENCADERNAÇÃO</h5>',
                ['controller' => 'Sdake64', 'action' => 'index'],
                ['class' => 'menu-gpqr', 'escape' => false]
            ) ?>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <?php echo $this->Html->link(
                '<i class="fa-solid fa-paste fa-5x spin" aria-hidden="true"></i>
