...
<h2 class="text-center text-gpqr mt-2 mb-4">CONFERÊNCIA ALFRESCO</h2>
<?= $this->Html->link(__('Serviços Concluídos'), ['action' => 'servicosConcluidos'], ['class' => 'btn btn-secondary float-end mb-4']) ?>
<?= $this->Form->create(null, ['url' => ['controller' => 'DigitConferencia', 'action' => 'add']]) ?>
