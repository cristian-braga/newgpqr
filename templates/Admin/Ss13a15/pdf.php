...
<head>
  ...
  <tr>
    ...
    <td colspan="2" style="text-align: center;font-size: 14px">'.$ss13a15['referencia'].'</td>
  </tr>
  ...
  <tr>
   <!--<td style="text-align: center; padding: 5px">RSS13055</td> -->
    ...
    <td style="text-align: center">'.$ss13a15['copias'].'</td>
    <td style="text-align: center">'.$ss13a15['paginas'].'</td>
    <td style="text-align: center">'.$ss13a15['capas'].'</td>
    <td style="text-align: center" bgcolor="#DEDCDC"><b>'.$ss13a15['total'].'</b></td>
    <td style="text-align: center">'.$ss13a15['job'].'</td>
  </tr>
  <tr>
    ...
    <td colspan="1" style="text-align: center;font-size: 15px;background-color: #DEDCDC"><b>'.$ss13a15['capas'].'</b></td>
    <td colspan="1" style="text-align: center;font-size: 15px;background-color: #DEDCDC"><b>'.$ss13a15['total'].'</b></td>
    <td colspan="1" style="text-align: center; font-size: 15px;background-color: #DEDCDC"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" style="font-weight:bold;text-align: center;">'.$ss13a15['funcionario'].'</td>
  ...
  <tr>
    ...
    <td colspan="2"></td>
    <td colspan="2" style="text-align: center;">'.$ss13a15['data'].'</td>
...
$mpdf->Output('Ss13A15.pdf', \Mpdf\Output\Destination::INLINE);
