...
$html = '<head>
  ...
  <tr>
    ...
    <td colspan="5" style="border: none"><b>SDAKE05</b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="5" style="border: none"><b>CAMG - Prédio Gerais, 5° andar, Div. Controle de Ciretrans</b></td>
    <!-- <td style="font-size: 12px">REF.</td>
    <td colspan="2" style="text-align: center">'.$sdake05['referencia'].'</td> -->
  </tr> 
  ...
  <tr>
    <td colspan="4" style="text-align: center">Relatório de Veículos</td>
    <td colspan="1" style="text-align: center;padding: 3px;font-size: 16px">'.$sdake05['copias'].'</td>
    <td colspan="1" style="text-align: center;font-size: 15px">'.$sdake05['paginas'].'</td>
    <td colspan="1" style="text-align: center;font-size: 15px">'.$sdake05['total'].'</td>
    <td colspan="1" style="text-align: center;font-size: 15px">'.$sdake05['capa'].'</td>
    <td colspan="4" style="text-align: center;font-size: 15px">'.$sdake05['job'].'</td>
  </tr>
    <tr>
        <td colspan="5" style="text-align: center" bgcolor="#DEDCDC" ><b>TOTAL</b></td>
        <td colspan="1" style="text-align: center" bgcolor="#DEDCDC"></td>
        <td colspan="1" style="text-align: center" bgcolor="#DEDCDC"><b>'.$sdake05['total'].'</b></td>
        <td colspan="1" style="text-align: center" bgcolor="#DEDCDC"><b>'.$sdake05['capa'].'</b></td>
        <td colspan="4" style="text-align: center" bgcolor="#DEDCDC"></td>
    </tr>
 <!-- <tr>
    ...
    <td colspan="7" style="text-align: center" bgcolor="#DEDCDC"><b>'.$sdake05['total2'].'</b>
  </tr> -->
  <tr>
  ...
  <tr>
    ...
    <td colspan="1" style="font-weight:bold;text-align: center;">'.$sdake05['funcionario'].'</td>
  ...
  <tr>
    ...
    <td colspan="1"></td>
    <td colspan="1" style="text-align: center;">'.$sdake05['dataAtual'].'</td>
