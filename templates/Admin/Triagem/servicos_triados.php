            ...
            <?php foreach ($triagem as $triagem) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?= $this->Form->postLink(__('Excluir'), ['action' => 'voltarEtapa', $triagem->id], ['class' => 'btn btn-outline-danger btn-sm btn-shadow', 'confirm' => __('Esta ação somente fará com que o serviço: {0} volte para "Aguardando Triagem". Deseja continuar?', $triagem->atividade->servico->nome_servico)]) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
