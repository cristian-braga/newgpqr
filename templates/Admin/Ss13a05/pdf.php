...
$html = '<head>
 ...
 <tr>
  ...
  <tr>
    ...
    <td colspan="4" style="border: none"><b>SS13A05</b></td> 
  ...
  <tr>
    ...
    <td colspan="2" style="text-align: center;font-size: 14px">'.$ss13a05['referencia'].'</td>
  </tr>
  ...
  <tr>
   <!--<td style="text-align: center; padding: 5px">RSS13055</td> -->
    <td colspan="8" style="font-size: 15px" >Relatório de Ocorrências - Limpeza Cargo</td>
    <td style="text-align: center">'.$ss13a05['copias'].'</td>
    <td style="text-align: center">'.$ss13a05['paginas'].'</td>
    <td style="text-align: center">'.$ss13a05['capas'].'</td>
    <td style="text-align: center" bgcolor="#DEDCDC"><b>'.$ss13a05['total'].'</b></td>
    <td style="text-align: center">'.$ss13a05['job'].'</td>
  </tr>
  <tr>
    ...
    <td colspan="1" style="text-align: center;font-size: 15px;background-color: #DEDCDC"><b>'.$ss13a05['capas'].'</b></td>
    <td colspan="1" style="text-align: center;font-size: 15px;background-color: #DEDCDC"><b>'.$ss13a05['total'].'</b></td>
    <td colspan="1" style="text-align: center; font-size: 15px;background-color: #DEDCDC"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" style="font-weight:bold;text-align: center;">'.$ss13a05['funcionario'].'</td>
  ...
  <tr>
    ...
    <td colspan="2"></td>
    <td colspan="2" style="text-align: center;">'.$ss13a05['data'].'</td>
...
$mpdf->Output('Ss13a05.pdf', \Mpdf\Output\Destination::INLINE);
