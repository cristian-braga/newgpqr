            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?= $this->Form->postLink(__('Excluir'), ['action' => 'delete', $ss13a05->id], ['class' => 'btn btn-outline-danger btn-sm btn-shadow'], ['confirm' => __('Are you sure you want to delete # {0}?', $ss13a05->id)]) ?>
