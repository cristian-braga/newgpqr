...
<?= $this->Form->create($ss13e015, ['id' => 'form', 'class' => 'mx-auto p-3 form', 'style' => 'width: 50%']) ?>
<div class="row g-3 mt-3">
    ...
    <div class="col-md-6">
        ...
        <?php echo $this->Form->control('paginas', ['type' => 'number', 'class' => 'form-control form-control1', 'maxlenght' => 4, 'placeholder' => 'N° de Páginas', 'label' => false]); ?>
    </div>
    <div class="col-md-6">
