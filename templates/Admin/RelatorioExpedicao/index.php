...
<div class="d-flex mb-5">
    <?= $this->Html->link(__('Exportar'), ['action' => 'exportar', '?' => ['filtro_servico' => $filtro_servico, 'data_inicio' => $data_inicio, 'data_fim' => $data_fim]], ['class' => 'btn btn-dark mx-auto']) ?>
</div>
...
<div class="table-gpqr mx-auto mb-5" style="width: 75%; overflow-y: auto; max-height: 95vh;">
        ...
        <tbody>
            <?php foreach ($grupos_servicos as $nome_servico => $expedicao) : ?>
                ...
                <tr class="table-light">
                    <td colspan="4"><b><?= h($nome_servico) ?> - Total:</b></td>
