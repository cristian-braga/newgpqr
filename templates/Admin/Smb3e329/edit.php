...
<?= $this->Form->create($smb3e329,['class' => 'mx-auto p-3 form', 'style' => 'width: 60%']) ?>
<div class="row g-3">
    <div class="col-md-6">
    ...
    <div class="col-md-6 mt-3">
        ...
        <?= $this->Form->control('data_cadastro', ['type' => 'date', 'class' => 'form-control', 'maxlenght' => 4, 'placeholder' => 'Data', 'label' => false]) ?>
    </div>
