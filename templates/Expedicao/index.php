<h3 class="text-center text-danger-emphasis mt-2 mb-4">EXPEDIÇÃO</h3>
            ...
            <?php foreach ($expedicao as $expedicao) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?= $this->Html->link(__('Excluir'), ['action' => 'delete', $expedicao->id], ['class' => 'btn btn-outline-danger btn-sm btn-shadow', 'confirm' => __('Realmente deseja excluir o serviço:  {0}?', $expedicao->id)]) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
